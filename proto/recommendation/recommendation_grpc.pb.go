...
const (
	...
	RecommendationService_GetTrendingMovies_FullMethodName  = "/recommendation.RecommendationService/GetTrendingMovies"
...
func (c *recommendationServiceClient) GetTrendingMovies(ctx context.Context, in *GetTrendingMoviesRequest, opts ...grpc.CallOption) (*GetTrendingMoviesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTrendingMoviesResponse)
	err := c.cc.Invoke(ctx, RecommendationService_GetTrendingMovies_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRecommendationServiceServer) GetTrendingMovies(context.Context, *GetTrendingMoviesRequest) (*GetTrendingMoviesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTrendingMovies not implemented")
}
...
func _RecommendationService_GetTrendingMovies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTrendingMoviesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).GetTrendingMovies(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendationService_GetTrendingMovies_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).GetTrendingMovies(ctx, req.(*GetTrendingMoviesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RecommendationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RecommendationService_GetTrendingMovies_Handler,
		},
		{
